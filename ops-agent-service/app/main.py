...
def create_app() -> FastAPI:
    ...
    def health() -> HealthResponse:
        ...
        components = [
            runtime.llm.health(),
            runtime.prometheus.health(),
            runtime.loki.health(),
            runtime.gateway_ops.health(),
        ]
    ...
    def explain_alert(payload: ExplainAlertRequest, request: Request) -> AnalyzeResponse:
...
def run_analysis(
    *,
    ...
    try:
        state = runtime.workflow.invoke(initial_state, config={"configurable": {"thread_id": thread_id}})
